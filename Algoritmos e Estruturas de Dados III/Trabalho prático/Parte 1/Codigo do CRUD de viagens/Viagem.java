...
public class Viagem implements Registro {
    ...
    // Implementação CORRETA do método toByteArray()
    public byte[] toByteArray() throws IOException {
        ...
        // CORREÇÃO: Escreve tamanho + bytes da string manualmente
    ...
    // Implementação CORRETA do método fromByteArray()
    public void fromByteArray(byte[] b) throws IOException {
        ...
        // CORREÇÃO: Lê tamanho e depois os bytes da string
